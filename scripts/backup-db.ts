 ...
 *   npm run backup
 *
 * Variables (además de las de la aplicación): BACKUP_DIR, BACKUP_RETENTION_DAYS, PG_BIN_DIR y, si el
 * rol de la aplicación no puede leer todas las filas (RLS forzado), BACKUP_DB_USER / BACKUP_DB_PASSWORD
 * con un superusuario o un rol con BYPASSRLS.
 */
