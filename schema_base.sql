...
CREATE TABLE IF NOT EXISTS productos (
  ...
  imagen_url TEXT,
  categoria VARCHAR(50) DEFAULT 'Cocina',
  estado VARCHAR(20) NOT NULL DEFAULT 'Activo'
);
...
CREATE TABLE IF NOT EXISTS ingredientes (
  ...
  stock_actual NUMERIC(10,4) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS mesas (
  ...
  camarero_id INTEGER REFERENCES usuarios(id)
);
...
CREATE TABLE IF NOT EXISTS cuentas (
  ...
  tipo_servicio VARCHAR(30) DEFAULT 'En Mesa',
  tipo_comprobante VARCHAR(10),
  ncf_ecf_generado VARCHAR(50),
  rnc_cedula_cliente VARCHAR(20),
  tarjeta_ultimos_4 VARCHAR(10),
  tarjeta_marca VARCHAR(50),
  metodo_pago VARCHAR(20),
  metodo_pago_2 VARCHAR(20),
  monto_pago_2 NUMERIC(10,2) DEFAULT 0,
  banco_pago_2 VARCHAR(100),
  moneda_pago VARCHAR(10) DEFAULT 'DOP',
  monto_extranjero NUMERIC(10,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS cuenta_detalles (
  id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS negocio_config (
  id SERIAL PRIMARY KEY,
  nombre_comercial VARCHAR(200) DEFAULT 'Mi Restaurante',
  razon_social VARCHAR(200),
  rnc VARCHAR(20) DEFAULT '130000001',
  telefono VARCHAR(30),
  direccion TEXT,
  ...
  cobrar_itbis BOOLEAN NOT NULL DEFAULT TRUE,
  cobrar_propina BOOLEAN NOT NULL DEFAULT TRUE,
  licencia_bloqueada BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS menu_categorias (
  ...
  grupo VARCHAR(50) DEFAULT 'Cocina'
);
