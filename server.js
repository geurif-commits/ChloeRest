...
import crearRouterInventario from './routes/inventario.js';
...
// Router de inventario (ingredientes y movimientos). Se monta después del
// middleware global de autenticación para que req.user esté disponible.
app.use(crearRouterInventario({ db, transaction, registrarAuditoria, requireRoles, ROLES_ADMIN }));
...
// Rutas de inventario movidas a routes/inventario.js (ver montaje al final del archivo).
...
// Rutas de ajuste y movimientos de inventario movidas a routes/inventario.js.
