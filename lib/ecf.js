...
// Construcción de e-CF según especificación DGII (e-CF 31/32/33/34).
export function construirECF({ tipoECF, ncf, cfg, rncReceptor, razonSocialReceptor, detalles, fechaEmision, tipoPago, fechaVencimientoSecuencia }) {
